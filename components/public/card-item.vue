<template>
	<div class="flex-1 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
		<a href="#" class="flex" style="height: 250px;">
			<img class="rounded-t-lg w-full" style="object-fit: cover;" :src="props.data.img" alt="" />
		</a>
		<div class="p-5">
			<a href="#">
				<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ props.data.title }}</h5>
			</a>
			<p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ props.data.text }}</p>
