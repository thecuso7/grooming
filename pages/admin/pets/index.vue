<template>
    <div>
        <h1 class="tw-text-3xl tw-text-black tw-pb-6 tw-font-heading">Питомцы</h1>
        <div class="tw-w-full tw-mt-12 tw-flex tw-flex-col">
            <div class="tw-dropdown-wrap tw-self-end tw-relative">
                <!-- Добавить нового питомца с кнопкой -->
                    ...
                    <ul class="tw-h-48 tw-px-3 tw-pb-3 tw-overflow-y-auto tw-text-sm tw-text-gray-700" aria-labelledby="dropdownSearchButton">
                        ...
                        <li>
                            <div class="tw-flex tw-items-center tw-p-2 tw-rounded-sm hover:tw-bg-gray-100 tw-group">
                                ...
                                <label for="checkbox-item-11" class="tw-w-full tw-ms-2 tw-text-sm tw-font-medium tw-text-white tw-rounded-sm group-hover:tw-text-gray-600">Кличка</label>
                            </div>
                        </li>
                        <li>
                            <div class="tw-flex tw-items-center tw-p-2 tw-rounded-sm hover:tw-bg-gray-100 tw-group">
                                <input id="checkbox-item-11" type="checkbox" v-model="showCols.age" class="tw-w-4 h-4 tw-text-blue-600 tw-bg-gray-100 tw-border-gray-300 tw-rounded-sm focus:tw-ring-blue-500">
                                <label for="checkbox-item-11" class="tw-w-full ms-2 tw-text-sm tw-font-medium tw-text-white tw-rounded-sm group-hover:tw-text-gray-600">Возраст</label>
                            </div>
                        </li>
                        <li>
                            <div class="tw-flex tw-items-center tw-p-2 tw-rounded-sm hover:tw-bg-gray-100 tw-group">
                                <input id="checkbox-item-11" type="checkbox" v-model="showCols.breed" class="tw-w-4 tw-h-4 tw-text-blue-600 tw-bg-gray-100 tw-border-gray-300 tw-rounded-sm focus:tw-ring-blue-500">
                                <label for="checkbox-item-11" class="tw-w-full tw-ms-2 tw-text-sm tw-font-medium tw-text-white tw-rounded-sm group-hover:tw-text-gray-600">Порода</label>
                            </div>
                        </li>
                        <li>
                            <div class="tw-flex tw-items-center tw-p-2 tw-rounded-sm hover:tw-bg-gray-100 tw-group">
                                <input id="checkbox-item-11" type="checkbox" v-model="showCols.features" class="tw-w-4 tw-h-4 tw-text-blue-600 tw-bg-gray-100 tw-border-gray-300 tw-rounded-sm focus:tw-ring-blue-500">
                                <label for="checkbox-item-11" class="tw-w-full tw-ms-2 tw-text-sm tw-font-medium tw-text-white tw-rounded-sm group-hover:tw-text-gray-600">Особенности</label>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script setup>
    ...
    watch(showCols, async() => {
        localStorage.setItem('showColsPets', JSON.stringify(showCols.value));
    }, {deep: true});

    onMounted(async() => {
        await loadPets({page: 1});
