    ...
    <div>
        ...
        <div class="w-full mt-12 flex flex-col">
            <div class="dropdown-wrap self-end relative">
                <button @click="toggleDropdown" id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-gray-800 rounded-lg hover:bg-gray-600 focus:ring-4 focus:outline-none" type="button">
                ...
                <!-- Dropdown menu -->
                <div id="dropdownSearch" class="mt-2 absolute z-10 bg-white rounded-lg shadow-sm w-60 dark:bg-gray-700 right-0" :class="{'hidden': !isOpenDropdown}">
                    <div class="p-3">
                    ...
                    <ul class="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700" aria-labelledby="dropdownSearchButton">
                        <li>
                            ...
                            <input id="checkbox-item-11" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500">
                            <label for="checkbox-item-11" class="w-full ms-2 text-sm font-medium text-white rounded-sm">Bonnie Green</label>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="bg-white overflow-auto rounded-lg mt-6">
                <table class="min-w-full bg-white">
                    <thead class="bg-gray-800 text-white">
                        <tr>
                            <!--
                            Передаем сюда все поля и управляем их показом и ссылка на пользователя, чтобы можно было его редактировать типа битрикса
                            -->
