    ...
    <div>
        ...
        <div class="tw-w-full tw-mt-12 tw-flex tw-flex-col">
            <div class="tw-dropdown-wrap tw-self-end tw-relative">
                <div class="tw-flex">
                    <RouterLink class="tw-inline-flex tw-items-center tw-px-4 tw-py-2 tw-mb-2 tw-text-sm tw-font-medium tw-text-center tw-text-white tw-bg-custom-olive tw-rounded-lg hover:tw-opacity-80 focus:tw-ring-4 tw-mr-2" to="/admin/users/add">Добавить</RouterLink>
                    <button @click="toggleDropdown($event)" id="dropdownButton" class="tw-inline-flex tw-items-center tw-px-4 tw-py-2 tw-mb-2 tw-text-sm tw-font-medium tw-text-center tw-text-white tw-bg-custom-olive tw-rounded-lg hover:tw-opacity-80 focus:tw-ring-4 focus:tw-outline-none" type="button">
...
<script setup>
    ...
    onMounted(async() => {
        await loadUsers({page: route.query?.page ?? 1});
