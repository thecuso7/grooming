<template>
    <div>
        <h1 class="tw-text-3xl tw-text-black tw-pb-6 tw-font-heading">Пользователи</h1>
...
<script setup>
    ...
    const loadUsers = async (params) => {
        /**
         * Получается, что только при запросе с пагинацией у нас будет показываться пагинация, иначе ничего не будет. Может тогда какой-то флаг добавить, показывать её или нет?
         * 
         * 
         */
